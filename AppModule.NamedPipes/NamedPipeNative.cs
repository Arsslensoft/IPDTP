...
namespace IPDTP.COM {
	...
	public sealed class NamedPipeNative {
		...
		/// <see cref="IPDTP.COM.SECURITY_ATTRIBUTES">SECURITY_ATTRIBUTES</see> 
		...
		/// <see cref="IPDTP.COM.Overlapped">Overlapped</see> object.</param>
		...
		/// <see cref="IPDTP.COM.SecurityAttributes">SecurityAttributes</see> 
