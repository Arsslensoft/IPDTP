...
namespace IPDTP.COM {
	...
	/// <see cref="IPDTP.COM.NamedPipeNative">NamedPipeNative</see> class
	...
	public sealed class NamedPipeWrapper {
		...
		/// <summary>
		/// Wait time for the 
		/// <see cref="IPDTP.COM.NamedPipeNative.WaitNamedPipe">NamedPipeNative.WaitNamedPipe</see> 
		/// operation.
		/// </summary>
		#endregion
		...
		/// <see cref="IPDTP.COM.NamedPipeWrapper.ReadBytes">IPDTP.COM.ReadBytes</see> 
		...
		/// <see cref="IPDTP.COM.NamedPipeWrapper.WriteBytes">IPDTP.COM.WriteBytes</see>
		...
		/// calling the <see cref="IPDTP.COM.NamedPipeWrapper.Connect">Connect</see>
