...
namespace IPDTP.COM {
	...
	public sealed class ClientPipeConnection : APipeConnection {
		...
		/// <see cref="IPDTP.COM.PipeHandle">PipeHandle</see> object
		/// and assigns it to the <see cref="IPDTP.COM.APipeConnection.Handle">Handle</see>
		/// field.<br/><br/>
