...
namespace IPDTP.COM {
	...
	/// <see cref="IPDTP.COM.ClientPipeConnection">ClientPipeConnection</see> 
	/// and <see cref="IPDTP.COM.ServerPipeConnection">ServerPipeConnection</see> 
	...
	public abstract class APipeConnection : IInterProcessConnection {
		#region Comments
		/// <summary>
		/// A <see cref="IPDTP.COM.PipeHandle">PipeHandle</see> object containing
		...
		/// </summary>
		/// <remarks>
		/// See the <see cref="IPDTP.COM.NamedPipeWrapper.Read">NamedPipeWrapper.Read</see>
		...
		/// </summary>
		/// <remarks>
		/// See the <see cref="IPDTP.COM.NamedPipeWrapper.ReadBytes">NamedPipeWrapper.ReadBytes</see>
		/// method for an explanation of the message format.
		/// </remarks>
		...
		#region Comments
		/// <summary>
		/// Gets the pipe connection state from the <see cref="IPDTP.COM.PipeHandle">PipeHandle</see> 
		/// object.
		/// </summary>
